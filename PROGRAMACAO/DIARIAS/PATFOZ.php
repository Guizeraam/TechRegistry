...
exit;
	...
	WHERE FILIAL = '01IND08' AND DT_ENTREGA=CONVERT(VARCHAR(8),GETDATE(),112)
...
<?php
	...
	$totalmes = "SELECT * FROM [dbo].[vw_LP_PROGRAMACAO] WHERE MONTH(DT_ENTREGA) = MONTH(GETDATE()) and YEAR(DT_ENTREGA) = YEAR(GETDATE()) AND FILIAL = '01IND08' ";
...
<div class="corpoF">
<br />
<p align="LEFT"><img id="rh2" src="/programacao//img/CABE_PATFOZ.png" ></p>
