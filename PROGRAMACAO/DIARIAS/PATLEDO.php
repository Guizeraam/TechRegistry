...
exit;
	...
	WHERE FILIAL = '01IND09' AND DT_ENTREGA=CONVERT(VARCHAR(8),GETDATE(),112)
...
<?php
	...
	$totalmes = "SELECT * FROM [dbo].[vw_LP_PROGRAMACAO] WHERE MONTH(DT_ENTREGA) = MONTH(GETDATE()) and YEAR(DT_ENTREGA) = YEAR(GETDATE()) AND FILIAL = '01IND09' ";
...
?>
<?php
//$query = sprintf("SELECT C5_XHRPROG, C5_X_QTDM3, C5_XDSCPRO, C5_X_NOME, C5_X_END, C5_X_OBS FROM SC5010 WHERE C5_XTIPO = 'P' AND C5_EMISSAO = '20180417' AND C5_FILIAL = '01IND08' ORDER BY C5_XHRPROG");
// executa a query
...
<div class="corpoF">
<br />
<p align="LEFT"><img id="rh2" src="/programacao//img/CABE_PATLEDO.png" ></p>
